...
public class AddMusicResourcesTable {
    ...
    // 本地音乐资源url
    private final String localMusicResourcesURL = "../../sqlresources/musicAudio/";
    // 本地音乐图片url
    ...
    public void start() throws SQLException {
        ...
        String sql = "INSERT INTO `music_resources`(gmt_create, gmt_modified, music_name, music_img_url, music_url, music_author) " +
                "VALUES(NOW(),NOW(),?,?,?,?) ";
